package com.example.coursework.ui.orders.list

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.example.coursework.data.FoodApi
import com.example.coursework.data.models.DeliveryOrder
        ...
        viewModelScope.launch {
            ...
            when (response) {
                ...
                is ApiResponse.Error -> {
                    ...
                    _state.value = OrdersListState.Error("Что-то пошло не так")
                }
            }
        }
    }
