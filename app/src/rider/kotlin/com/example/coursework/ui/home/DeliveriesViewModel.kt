...
import com.example.coursework.data.models.Deliveries
    ...
    private suspend fun processDeliveryStateUpdate(response: ApiResponse<GenericMsgResponse>) {
        ...
        when (response) {
            ...
            is ApiResponse.Error -> {
                ...
                _deliveriesState.value =
                    DeliveriesState.Success(deliveries.value?.data!!)
                _deliveriesEvent.emit(DeliveriesEvent.ShowError("Произошла ошибка"))
            }
        }
    }
            ...
            try {
                ...
                when (response) {
                    ...
                    is ApiResponse.Error -> {
                        ...
                        _deliveriesState.value = DeliveriesState.Error("Произошла ошибка")
                    }
                }
            } catch (e: Exception) {
                _deliveriesState.value = DeliveriesState.Error("Произошла ошибка")
